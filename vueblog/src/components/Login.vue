<template>
  <el-form :rules="rules" class="login-container" label-position="left"
    ...
    <h3 class="login_title" v-if="login">系统登录</h3>
    ...
    <el-button style="margin-left: 80px;" v-if="login" @click="login=false; clearForm();">注册</el-button>
    <el-button style="margin-left: 80px;" v-else @click="login=true; clearForm();">登录</el-button>
  ...
  methods: {
    ...
    submitClick: function (type) {
      ...
      if (type == 1) {
        ...
        url = '/reg' //https://zhangz1.top/articles/223
      }
      postRequest( url, {
